                    ...
                    <div className="px-4 pb-4 overflow-y-auto max-h-96">
                        ...
                        <ul className="space-y-2">
                            {suppliers.map(supplier => (
                                <li key={supplier._id} onClick={() => handleSelect(supplier)} className="flex items-center p-3 transition-colors rounded-lg cursor-pointer hover:bg-orange-50">
                                    <div className="flex items-center justify-center w-10 h-10 mr-4 font-bold text-orange-600 bg-orange-100 rounded-full">{supplier.name.charAt(0)}</div>
                                    <div>
